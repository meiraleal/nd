...
var temp__6501__auto__ = cljs.core.deref.call(null,devtools.sanity_hints.processed_errors);
if(cljs.core.truth_(temp__6501__auto__)){
var val = temp__6501__auto__;
return val;
} else {
...
var reader = (function (){var or__21445__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"file-reader","file-reader",-450847664));
...
var min_length = (function (){var or__21445__auto__ = devtools.prefs.pref.call(null,new cljs.core.Keyword(null,"sanity-hint-min-length","sanity-hint-min-length",104958154));
if(cljs.core.truth_(or__21445__auto__)){
return or__21445__auto__;
} else {
return (128);
...
var map__30549 = top_item;
var map__30549__$1 = ((((!((map__30549 == null)))?((((map__30549.cljs$lang$protocol_mask$partition0$ & (64))) || (map__30549.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__30549):map__30549);
...
}catch (e30548){var _e = e30548;
return false;
}});
devtools.sanity_hints.type_error_to_string = (function devtools$sanity_hints$type_error_to_string(self){
var temp__6501__auto___30551 = devtools.sanity_hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__6501__auto___30551)){
var seen_errors_30552 = temp__6501__auto___30551;
if(cljs.core.truth_(seen_errors_30552.has(self))){
} else {
seen_errors_30552.add(self);

var temp__6503__auto___30553 = devtools.sanity_hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__6503__auto___30553)){
var sense_30554 = temp__6503__auto___30553;
self.message = [cljs.core.str(self.message),cljs.core.str(", a sanity hint:\n"),cljs.core.str(sense_30554)].join('');
} else {
}
}
} else {
...
var temp__6503__auto__ = devtools.sanity_hints.error_object_sense.call(null,error);
if(cljs.core.truth_(temp__6503__auto__)){
var sense = temp__6503__auto__;
...
//# sourceMappingURL=sanity_hints.js.map?rel=1471651299008