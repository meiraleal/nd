...
var m__22159__auto__ = (sablono.util.to_str[goog.typeOf(x__22158__auto__)]);
if(!((m__22159__auto__ == null))){
return m__22159__auto__.call(null,x);
} else {
var m__22159__auto____$1 = (sablono.util.to_str["_"]);
...
var x__22158__auto__ = (((x == null))?null:x);
var m__22159__auto__ = (sablono.util.to_uri[goog.typeOf(x__22158__auto__)]);
if(!((m__22159__auto__ == null))){
return m__22159__auto__.call(null,x);
} else {
var m__22159__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__22159__auto____$1 == null))){
return m__22159__auto____$1.call(null,x);
} else {
...
var len__22628__auto___22914 = arguments.length;
var i__22629__auto___22915 = (0);
while(true){
if((i__22629__auto___22915 < len__22628__auto___22914)){
args__22635__auto__.push((arguments[i__22629__auto___22915]));

var G__22916 = (i__22629__auto___22915 + (1));
i__22629__auto___22915 = G__22916;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__22636__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq22913){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq22913));
});
...
var vec__22920 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var seq__22921 = cljs.core.seq.call(null,vec__22920);
var first__22922 = cljs.core.first.call(null,seq__22921);
var seq__22921__$1 = cljs.core.next.call(null,seq__22921);
var first_word = first__22922;
var words = seq__22921__$1;
...
var G__22924 = clojure.set.rename_keys.call(null,m,kmap);
if(cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.call(null,G__22924,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys);
} else {
return G__22924;
}
} else {
...
return clojure.string.join.call(null," ",cljs.core.flatten.call(null,cljs.core.map.call(null,(function (p1__22925_SHARP_){
if(typeof p1__22925_SHARP_ === 'string'){
return p1__22925_SHARP_;
} else {
return cljs.core.seq.call(null,p1__22925_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__21445__auto__ = x__$1.hasDomain();
...
//# sourceMappingURL=util.js.map?rel=1471651204785